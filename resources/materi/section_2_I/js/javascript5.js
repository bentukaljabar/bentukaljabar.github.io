...
let jawabanB = document.querySelector('.jawabanB');
...
langkh.addEventListener('click', function () {
    if (kondisi == 0) {
        ...
        langkh.innerText = 'Pembahasan soal a';
        kondisi += 1;
    } else if (kondisi == 2) {
        jawabanA.className = jawabanA.className.replace('hilang1', '');
        langkh.innerText = 'Pembahasan soal b';
        kondisi += 1;
    } else if (kondisi == 3) {
        jawabanB.className = jawabanB.className.replace('hilang1', '');
